...
public class HostToolkit {
    ...
    //TODO: Include amenities, but it would not be exact, just at least
    public static void suggestPrice(Connection conn, String type, String country, String city, String street, String postal){
        ...
        try {
            Statement stmt = conn.createStatement();
            //Should I do average based on avg(price) 
            ...
            if(rs.next()){
                ...
                if(avg != null){
                    System.out.print(String.format("Suggested Price (based on avg price per night of %s listings in %s, %s on street %s, with postal %s): $", type, country, city, street, postal));
                    DecimalFormat df = new DecimalFormat("0.00");
            ...
            if(rs2.next()){
                ...
                if(avg != null){
                    System.out.print(String.format("Suggested Price (based on avg price price per night of %s listings in %s, %s on street %s): $", type, country, city, street));
                    DecimalFormat df = new DecimalFormat("0.00");
                    System.out.println(df.format(Float.parseFloat(avg)));
                    return;
                }
            ...
            if(rs3.next()){
                ...
                if(avg != null){
                    System.out.print(String.format("Suggested Price (based on avg price per night of %s listings in %s, %s): $", type, country, city));
                    DecimalFormat df = new DecimalFormat("0.00");
                    System.out.println(df.format(Float.parseFloat(avg)));
                    return;
                }
            ...
            if(rs4.next()){
                ...
                if(avg != null){
                    System.out.print(String.format("Suggested Price (based on avg price per night of %s listings in %s): $", type, country));
                    DecimalFormat df = new DecimalFormat("0.00");
                    System.out.println(df.format(Float.parseFloat(avg)));
                    return;
                }
            ...
            if(rs5.next()){
                ...
                if(avg != null){
                    System.out.print(String.format("Suggested Price (based on avg price per night of %s listings on MyBnB): $", type));
                    DecimalFormat df = new DecimalFormat("0.00");
                    System.out.println(df.format(Float.parseFloat(avg)));
                    return;
                }
